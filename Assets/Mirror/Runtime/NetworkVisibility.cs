...
namespace Mirror
{
    ...
    public abstract class NetworkVisibility : NetworkBehaviour
    {
        ...
        public abstract bool OnCheckObserver(NetworkConnectionToClient conn);
        ...
        public abstract void OnRebuildObservers(HashSet<NetworkConnectionToClient> observers, bool initialize);
